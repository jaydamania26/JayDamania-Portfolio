...
export default class MonitorScreen extends EventEmitter {
    ...
    // Reference to the invisible click layer
    ...
    createIframe() {
        ...
        // IMPORTANT: Relative position so we can stack the blocker on top
        ...
        // --- BLOCKER CREATION ---
        // This is the transparent layer that captures the "Enter" click
        ...
        blocker.style.zIndex = '999'; // Must be higher than Iframe
        blocker.style.cursor = 'pointer'; // Hand cursor to indicate interactivity
        blocker.id = 'monitor-blocker';
        
        // When clicked, trigger the camera
